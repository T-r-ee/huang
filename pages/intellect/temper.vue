<template>
	...
	<intellect title="温度" text='提交' @rightBtn="rightBtn()">
		<view class="content-box">
			...
			<view class="temp" v-if="checkUp">
				...
				<picker :range="array" :value="temper" @change="bindTemperChange">
					<view class="box">
						<text>{{temper}}℃</text>
			...
			<view class="temp" v-if="checkDown">
				<text class="title">温度</text>
				<picker :range="array" :value="0" @change="bindTemperChange">
					<view class="box">
						<text>{{temper}}℃</text>
						<image src="../../static/right.png"></image>
					</view>
	...
	export default {
		...
		methods: {
			bindTemperChange(e) {
				...
				this.temper = this.array[e.detail.value]
			},
			rightBtn() {
