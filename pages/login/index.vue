		...
		<view class="group_2">
			<button class="button_1 flex" @click="loginHandle">
				<view class="image-text_1">
					<image src="../../static/wx.png" class="icon_1"></image>
					<span class="text-group_1">微信一键登录</span>
				</view>
			</button>
			<button class="button_2 flex" @click="goto('verify')">
				<span class="text_2">手机验证码登录</span>
			</button>
			<span class="text_3 flex" @click="goto('password')">手机账号密码登录&gt;&gt;</span>
		</view>
